...
const Testimonial = () => {
     ...
     const testimonials = [
        ...
        { 
          name: "Ayush verma", 
          location: "Dhausar,barabanki,up,india", 
          image: assets.testimonial_image_2, 
          testimonial: "CarRental made my trip so much easier. The car was delivered right to my door, and the ccustomer service was fantastic!" 
        },
        { 
          name: "Ayansh Verma", 
          location: "Gangaully,barabanki,up,india", 
